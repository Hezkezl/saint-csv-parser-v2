...
/**
 * php bin/console app:parse:csv GE:Testquest2
 */
class TestQuest2 implements ParseInterface
{
    use CsvParseTrait;
            ...
            */
            ...
            if (!empty($quest['Id'])) {
                ...
                foreach ($textdata->data as $i => $entry) {
                    ...
                    //because im lazy i just fixed a small problem here
                    $dialogue = str_replace("\n----\n}}", "}}", implode("\n\n", array_unique($DialogueArray)));
