...
class TestNPC implements ParseInterface
{
    ...
    public function parse()
    {
                ...
                if(!empty($ENpcBase["ENpcData[$i]"])) {
                    ...
                    switch (true) {
                        ...
                        case ($DataValue > 262100) && ($DataValue < 269999): //GILSHOP
                            $GilShop Name = $GilShopCsv->at($DataValue)['Name'];
                            ...
                            $DefaultTalkAccept = $this->getDefaultTalk($DefaultTalkCsv, $GilShopCsv, $DataValue ,'AcceptTalk', '|Success Talk = ');
                            $DefaultTalkFail = $this->getDefaultTalk($DefaultTalkCsv, $GilShopCsv, $DataValue ,'FailTalk', '|Fail Talk = ');
                            $GilShopItemArray = [];
                            ...
                            foreach(range(0,29) as $a) {
                                ...
                                switch (true) {
                                    ...
                                    case (strpos($Instruction, 'DISPOSAL') !== false):
                                        $Shop Name = $DisposalShopCsv->at($Argument)['ShopName'];
                                        $DisposalShopArray = [];
                                ...
                                foreach(range(1,99) as $b) {
                                    ...
                                    switch (true) {
                                        ...
                                        case ($NestDataValue > 262100) && ($NestDataValue < 269999)://Gilshop
                                            $GilShop Name = $GilShopCsv->at($NestDataValue)['Name'];
                                            ...
                                            $DefaultTalkAccept = $this->getDefaultTalk($DefaultTalkCsv, $GilShopCsv, $NestDataValue ,'AcceptTalk', '|Success Talk = ');
                                            $DefaultTalkFail = $this->getDefaultTalk($DefaultTalkCsv, $GilShopCsv, $NestDataValue ,'FailTalk', '|Fail Talk = ');
                                            $GilShopItemArray = [];
                                        ...
                                        case ($NestDataValue > 1769000) && ($NestDataValue < 1779999)://SPECIALSHOP
                                            ...
                                            $SpecialShop Name = $SpecialShopCsv->at($SpecialShopID)['Name'];
                                            $UnlockQuest = "";
                                            ...
                                            $CompleteTextStringOut = $this->getDefaultTalk($DefaultTalkCsv, $SpecialShopCsv, $NestDataValue ,'CompleteText', 'Success Talk');
                                            $NotCompleteTextStringOut = $this->getDefaultTalk($DefaultTalkCsv, $SpecialShopCsv, $NestDataValue ,'NotCompleteText', 'Fail Talk');
                                            $ShopsLinkArray[] = $SpecialShopName;
                                            $ShopArray[] = "\n{{-start-}}\n'''". $Name ."/". $SpecialShopName ."'''\n|NPC Name = ". $Name ."\n|Shop Name = ". $SpecialShopName ."\n". $UnlockQuest ."\n". $SpecialShopOutput ."". $CompleteTextStringOut ."". $NotCompleteTextStringOut ."{{-stop-}}";
                                        break;
                                        ...
                                        case ($NestDataValue > 3470000) && ($NestDataValue < 3479999)://disposal
                                            $Shop Name = $DisposalShopCsv->at($NestDataValue)['ShopName'];
                                            $DisposalShopArray = [];
                        ...
                        case ($DataValue > 1769000) && ($DataValue < 1779999)://SPECIALSHOP
                            ...
                            $CompleteTextStringOut = $this->getDefaultTalk($DefaultTalkCsv, $SpecialShopCsv, $DataValue ,'CompleteText', '|Success Talk = ');
                            $NotCompleteTextStringOut = $this->getDefaultTalk($DefaultTalkCsv, $SpecialShopCsv, $DataValue ,'NotCompleteText', '|Fail Talk = ');
                            $ShopsLinkArray[] = $SpecialShopName;
                            $ShopArray[] = "\n{{-start-}}\n'''". $Name ."/". $SpecialShopName ."'''\n|NPC Name = ". $Name ."\n|Shop Name = ". $SpecialShopName ."\n". $UnlockQuest ."\n". $SpecialShopOutput ."". $CompleteTextStringOut ."". $NotCompleteTextStringOut ."{{-stop-}}";
                        break;
                        ...
                        case ($DataValue > 2752000) && ($DataValue < 2752999)://FCCSHOP
                            $FCCShopItemArray = [];
                            $Shop Name = $FCCShopCsv->at($DataValue)['Name'];
                            foreach(range(0,9) as $b) {
                        ...
                        case ($DataValue > 3270000) && ($DataValue < 3279999)://TOPIC SELECT
                            ...
                            foreach(range(0,9) as $b) {
                                ...
                                if ($ShopLink >= 262000 && $ShopLink < 264000) { // links to GilShop
                                    $Shop Name = $GilShopCsv->at($ShopLink)["Name"];
                                ...
                                if ($ShopLink >= 3538900 && $ShopLink < 3540000) { // links to PreHandler
                                    ...
                                    if ($ShopID > 262100 && $ShopID < 269999) { //Gilshop
                                        $Shop Name = $GilShopCsv->at($ShopID)["Name"];
                                        $GilShopItemArray = [];
                                        foreach(range(0,50) as $c) {
                                        ...
                                        $GilShopItemArrayOutput = implode("\n", $GilShopItemArray);
                                        $ShopsLinkArray[] = $ShopName;
                                        $ShopArray[] = "\n{{-start-}}\n'''". $Name ."/". $ShopName ."'''\n|NPC Name = ". $Name ."\n|Shop Name = ". $ShopName ." =\n{{Tabsells". $GilShopItemArrayOutput ."{{-stop-}}";
                                    }
                                    ...
                                    if ($ShopID >= 3866620 && $ShopID < 3866999) { //COLLECTABLESHOPS
                                        $Shop Name = $CollectablesShopCsv->at($ShopID)['Name'];
                        ...
                        case ($DataValue > 3470000) && ($DataValue < 3479999):
                            $Shop Name = $DisposalShopCsv->at($DataValue)['ShopName'];
                            $DisposalShopArray = [];
                            foreach(range(0,400) as $b) {
                                $SubDataValue = "". $DataValue .".". $b ."";
                                if (empty($DisposalShopCsv->at($SubDataValue)['Item{Received}'])) break;
                        ...
                        case ($DataValue > 3530000) && ($DataValue < 3539999)://PREHANDLER
                            $ShopID = $PreHandlerCsv->at($DataValue)["Target"];
                                    ...
                                    if ($ShopID >= 3473400 && $ShopID < 3479999) { //DISPOSALSHOP
                                        $Shop Name = $DisposalShopCsv->at($ShopID)['ShopName'];
                                        $DisposalShopArray = [];
        ...
        $output = implode("\n\n\n",str_replace("\n\n\n\n\n", "", $outputarray)); // because im messy and lazy
        $data = [
            '{output}' => $output,
        ];
